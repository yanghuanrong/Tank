...
Tank.prototype.setDirection = function(dir) {
  ...
  if(dir == 'right') {
    setCss(tank, 'backgroundPosition', '-896px 0');
  }
  if(dir == 'down') {
    setCss(tank, 'backgroundPosition', '-1792px 0');
  }
  if(dir == 'left') {
    setCss(tank, 'backgroundPosition', '-2688px 0');
  }
  this.dirState[dir] = 1;
};
